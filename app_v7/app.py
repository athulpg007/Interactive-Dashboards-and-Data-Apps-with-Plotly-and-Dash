...
link_budget_layout = html.Div([
	...
	dbc.Col([html.Div(children=html.Strong('Presets:')),
	...
	dbc.Row([
		dbc.Col(lg=1),
		dbc.Col([html.Div(children=html.Strong('Frequency, GHz')),
				 dcc.Input(id='link-budget-frequency', min=0.001, max=100, type='number')], lg=2),
		dbc.Col([html.Div(children=html.Strong('Transmit power, W')),
				 dcc.Input(id='link-budget-pt', min=0, max=1000, type='number')], lg=2),
		dbc.Col([html.Div(children=html.Strong('Transmitter gain, dBi')),
	...
	if unquote(pathname[1:]) in 'aerocapture':
		...
		if type == 'lift-modulation':
			...
			if exitflag_us == 1 and exitflag_os == 1:
				...
				fig.update_layout(height=750,
				                  title_text="Overshoot and Undershoot trajectories vs time (min)")
